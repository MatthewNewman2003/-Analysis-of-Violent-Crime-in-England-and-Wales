...
DataFrame = pd.read_csv("policeforceareatablesyearendingmarch2018v2.csv", na_values=MissingValues)
...
DataFrame["Homicide"] = np.where(DataFrame["Homicide"] > 40, 11, DataFrame["Homicide"])
...
DataFrame["Violence with injury"] = np.where(DataFrame["Violence with injury"] > 26525, 8339, DataFrame["Violence with injury"])
...
#Replacing outliers with median value of violence with injury
DataFrame["Violence without injury"] = np.where(DataFrame["Violence without injury"] > 33001, 9782, DataFrame["Violence without injury"])
...
#Replacing outliers with median value of violence with injury
DataFrame["Stalking and harassment"] = np.where(DataFrame["Stalking and harassment"] > 20232, 4369, DataFrame["Stalking and harassment"])
...
#Replacing outliers with median value of violence with injury
DataFrame["Death or serious injury - unlawful driving"] = np.where(DataFrame["Death or serious injury - unlawful driving"] > 44, 11, DataFrame["Death or serious injury - unlawful driving"])
...
DataFrame.to_csv("March 2018 Cleaned Dataset.csv")
